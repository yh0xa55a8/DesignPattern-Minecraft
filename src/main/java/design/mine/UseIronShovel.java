...
import trolley.BigTrolley;
import trolley.IronType;
import trolley.Trolley;
import trolley.Type;
...
public class UseIronShovel extends UseToolsServiceMineralImpl {
    ...
    public void useTrolleys(String size){
        ...
        if(size.equals("大车")){
            ...
            System.out.println("您正在使用大铁矿用车" + name);
        }
        if(size.equals("小车")){
            Trolley trolley = useSmallTrolley();
            String name = trolley.getSize();
            System.out.println("您正在使用小铁矿用车" + name);
        }
    }
